...
const events =
[
    new Event("Parent Meeting", new Date(2022, 7, 31), "Online: MS Teams, 7:00 p.m. - 7:30 p.m.", "Online meeting between the parents of TSA members and the leadership team. TSA members are not required to attend but they should let their parents know. Parents will attend the meeting through MS Teams with the link: <a href='https://teams.live.com/meet/9386199220546'>https://teams.live.com/meet/9386199220546</a><br><br>Meeting Notes:<br><br>-The majority of what we went over can be found on this powerpoint here: <a href='https://docs.google.com/presentation/d/1hi1Iip9vN2pZtsu7s2ZDwGNVPG8qB6JdRtEGPi-ZRfQ/edit?usp=sharing'>Presentation</a> <br><br>Additional Notes:<br><br>-Our next meeting will be held on Tuesday 9/6 instead of the first Monday of September<br>-Elections to fill the Historian position will be held on our next meeting (9/6)<br>-The Drone competition will be held in cooperation with the Lyman Drone club which is run by Mr. Blizard"),

    new Event("First Meeting", new Date(2022, 7, 22), "Ms. Acken's Room, 06-039, 2:30 - 3:30 p.m.", "<strong>Highly recommended for all members.</strong> From 2:30 p.m. - 3:30 p.m. We will be going over important information regarding TSA. This includes what TSA is, future meeting dates, communication, conference dates, competition selections, and the upcoming special election.<br><br>Meeting Notes:<br><br>-Went over Parliamentary Procedure<br><br>-Introduction of officers<br><br>-Historian election will be occuring during our next meeting. Anyone is welcome to run. All you need is to show up to the next meeting and have a speech ready.<br><br>-Overview of what TSA is<br><br>-Future meeting dates (can be found on the schedule page)<br><br>-Join our GroupMe (can be found on the join page)<br><br>-We have a website (this one!)<br><br>-Conference dates (can be found on the schedule page)<br><br>-Competition selection: submit your selections before the third meeting (9/19) on the competitions page<br><br>-Overview of competitive events (can be found on the national site which can be found on the resources page of our site)<br><br>-Come help us at the Lyman Open House (more information on the announcements page)", "IMPORTANT"),
